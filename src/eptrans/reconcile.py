...
The GenomeSPOT paper (Barnum et al. 2024) states in its methods that models were
applied to GTDB release **r214** (the abstract reports "all 85,205 species of
sequenced bacteria and archaea"). The per-genome predictions themselves are NOT
