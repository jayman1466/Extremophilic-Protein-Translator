// Sequence-track renderer: three orthogonal channels on one sequence so they
// never collide — conservation (background shade), active site (underline+dot),
// mutation (orange/magma box). Exact values live in per-residue hover tooltips.
//
